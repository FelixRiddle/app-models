const {
    ...
    User,
    UserMessages,
} = require("../models/SQL/runtime/index");
const mysqlConn = require("../connection/mysqlConn");
const printMysqlEnvironmentVariables = require('../env/printMysqlEnvironmentVariables');
...
// Main
module.exports = async function tablesMain(args) {
